...
const Testimonials = () => {
  return (
    <div className="w-screen flex items-center justify-center bg-[#08102F]">
      <main className="w-[1440px] h-[1080px] bg-[url('/png/frame-1-lines.png')] bg-opacity-10 flex items-center justify-center relative flex-col gap-10 p-28 max-md:px-10 max-md:py-16 max-sm:px-5 max-sm:py-10">
        <section>
